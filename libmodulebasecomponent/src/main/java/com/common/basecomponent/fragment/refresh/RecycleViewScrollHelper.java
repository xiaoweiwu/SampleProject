...
import com.common.basecomponent.fragment.PullToRefreshFragmentEx;
...
//            L.w("item count :" + linearManager.getItemCount() + "\n" + " lastVisibleItemPosition " + linearManager.findLastVisibleItemPosition() + "\n" + "lastCompletelyVisibleItemPosition" + linearManager.findLastCompletelyVisibleItemPosition());
            ...
            if (lastItemPosition != adapter.getItemCount() - 1 && adapter.getItemCount() - lastItemPosition <= 5) {
...
//        }
//        L.e("lastItemPosition ：" + lastItemPosition  +" itemCount : " + itemCount + "(itemCount -lastItemToBottom) : " + (itemCount -lastItemToBottom));
...
//                    L.e("onScrollToUnknown" + "bottom : " + bottom + "bottomEdge : " + bottomEdge + "top : " + top + "topEdge : " + topEdge + " childcount : " + childCount);
...
//        cheackBackToTop(recyclerView);
    ...
    private void cheackBackToTop(RecyclerView recyclerView) {
        if (mOnScrollToShowBackTop != null) {
            ...
            if (layoutManager instanceof LinearLayoutManager) {
                if (recyclerView.getAdapter() instanceof RecyclerAdapterWithHF) {
                    ...
                    RecyclerAdapterWithHF adapterWithHF = (RecyclerAdapterWithHF) recyclerView.getAdapter();
                    //因为第一屏有head 因此要 减去head (head较占空间。减低误差)
                    int threeScreen = (PullToRefreshFragmentEx.LIST_PAGE_SIZE - adapterWithHF.getHeadSize()) * PullToRefreshFragmentEx.SHOWTOP_BY_SCRENN;
...
//                recyclerView.setOnScrollListener(this);
    ...
    public void unAttachToRecycleView() {
        if (mRvScroll != null) {
//            mRvScroll.removeOnScrollListener(this);//TODO
            mRvScroll.setOnScrollListener(null);
        }
        this.reset();
    }
    ...
    public interface OnScrollVerticalDirectionListener {
         ...
         */
        void onScrollVerticalDirection(boolean isPullUp);
    }

    public interface OnScrollToShowBackTop {

        void showBackToTop(boolean isShow);
    }
}
