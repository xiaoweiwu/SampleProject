...
import com.fullshare.zxing.view.ViewfinderResultPointCallback;
...
public final class CaptureActivityHandler extends Handler {
    ...
    public CaptureActivityHandler(Activity activity, DecodeCallback callback, Vector<BarcodeFormat> decodeFormats,
                                  String characterSet) {
        this.activity = activity;
        this.decodeCallback = callback;
        decodeThread = new DecodeThread(activity, decodeCallback, decodeFormats, characterSet,
                new ViewfinderResultPointCallback(callback.getScannerView()));
        decodeThread.start();
        state = State.SUCCESS;
