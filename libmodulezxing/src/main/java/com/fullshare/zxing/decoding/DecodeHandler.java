...
final class DecodeHandler extends Handler {
    ...
    DecodeHandler(Activity activity, DecodeCallback decodeCallback, Hashtable<DecodeHintType, Object> hints) {
    ...
    private void decode(byte[] data, int width, int height) {
        ...
        if (rawResult != null) {
            ...
            Message message = Message.obtain(decodeCallback.getHandler(), R.id.decode_succeeded, rawResult);
...
//      bundle.putParcelable(DecodeThread.BARCODE_BITMAP, source.renderCroppedGreyscaleBitmap());
            ...
            Message message = Message.obtain(decodeCallback.getHandler(), R.id.decode_failed);
            message.sendToTarget();
        }
    }
